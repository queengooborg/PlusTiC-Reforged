...
public class Config extends Configuration {
	...
	public void init1() {
		...
		for (String traitLoadEntry: this.getStringList("Force load traits", "tweaks", new String[0], "Force-load these traits (as a fully-qualified class name; e.g. queengooborg.plustic.traits.Global) without the required mods themselves being loaded")) {
			try {
